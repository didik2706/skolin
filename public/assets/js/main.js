...
$(function() {
    ...
    $(window).on("scroll", function(event) {
        ...
        if (roll < 850) {
            $(".nav-pills").removeClass("shadow pb-1 pt-1");
        } else {
            $(".nav-pills").addClass("shadow pb-1 pt-1");
        }
    });
            ...
            n(t)
                ...
                n(t).find(".nav-search").length > 0 &&
                    n(t)
                        ...
                        .find("form")
                        .prepend(
                            "<span class='nav-search-close-button'>âœ•</span>"
                        ),
                (u.init = function() {
    ...
    // == Function Drag dan Add New Photo == //
