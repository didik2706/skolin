...
@section('content')
    <div id="content" class="content">
        <!-- begin breadcrumb -->
        <a class="pull-right btn-success btn" href="../index.html">Halaman Sekolah</a>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <div class="alert alert-success fade show col-10">Selamat Datang di {{ Auth::User()->sekolah->nama_sekolah }}</div>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-3 -->
