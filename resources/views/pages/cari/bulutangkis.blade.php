                ...
                <div class="col-lg-3 col-filter show mt-50">
                    ...
                    <div class="courses-sidebar">
                      <div class="courses-sidebar-fee card-header bg-light rounder mt-30">
                        ...
                        <form class="fee-items" action="{{ url('cari/filter-bulutangkis') }}" method="GET">
                          <div class="courses-search tab-filter">
                              <input type="text" placeholder="Nama Sekolah Bulutangkis" name="search_list">
                          </div>
                      ...
                      <div class="mt-5 col-filter show" id="filterTab">
                        ...
                        <div class="sidebar-title">
                          <h5 class="sub-title">Kategori Berdasakan Level</h5>
                        </div>
                        <ul class="category-items">
                          <li>
                            <div class="form-check">
