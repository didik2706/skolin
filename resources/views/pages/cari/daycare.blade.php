                        ...
                        <div class="tab-content" id="contentPencarian">
                            <div class="tab-pane fade show active" id="grid" role="tabpanel">
                                ...
                                {{-- <div class="container-lg mt-4">
                                    <p>Page {{ $sekolahs->currentPage() }} of {{$sekolahs->total()}} results</p>
                                </div> --}}
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-filter show mt-50">
                    <div class="courses-sidebar">
                        <div class="courses-sidebar-fee card-header bg-light rounder mt-30">
                            ...
                            <form class="fee-items" action="{{ url('cari/filter-daycare') }}" method="GET">
                                <div class="courses-search tab-filter">
                                    <input type="text" placeholder="Nama Daycare" name="search_list">
                                </div>
