    ...
    <section class="top-courses-area">
        <div class="container">
            <div class="row">
                ...
                {{-- sidebar filter --}}
                <div class="col-lg-3 col-filter mt-50">
                    ...
                    <div class="courses-sidebar">
                      <div class="courses-sidebar-fee card-header bg-light rounder mt-30">
                        ...
                        <form class="fee-items" action="{{ url('cari/filter-preschool') }}" method="GET">
                          <div class="courses-search tab-filter">
                              <input type="text" placeholder="Nama Preschool" name="search_list">
                          </div>
                      ...
                      <div class="mt-5 col-filter" id="filterTab">
                        <div class="sidebar-title">
                        ...
                        <div class="sidebar-title">
                          <h5 class="sub-title">Perpaduan Kurikulum</h5>
                        </div>
                        <ul class="category-items">
                          <li>
                            <div class="form-check">
                          ...
                          <li>
                            <div class="form-check">
                              <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" value="">
                                International Baccalraurete (IB)
                              </label>
                            </div>
                          </li>
                          <li>
                        ...
                        <div class="sidebar-title">
                          <h5 class="sub-title">Berdasarkan Bahasa Pengantar</h5>
                        </div>
                        <ul class="category-items">
                          <li>
                            <div class="form-check">
                          ...
                          <li>
                            <div class="form-check">
                              <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" value="">
                                Mulillingual (Indonesia - English - Arabic)
                              </label>
                            </div>
                          </li>
                          <li>
                            <div class="form-check">
                              <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" value="">
                                Mulillingual (Indonesia - English - Mandarin)
                              </label>
                            </div>
                          </li>
                          <li>
                        ...
                        <div class="sidebar-title">
                          <h5 class="sub-title">Pembelajaran</h5>
                        </div>
                        <ul class="category-items">
                          <li>
                            <div class="form-check">
                        ...
                        <div class="courses-sidebar-fee bg-light rounder">
                          <div class="sidebar-title">
                            <h5>Biaya</h5>
                          </div>
                          <br>
